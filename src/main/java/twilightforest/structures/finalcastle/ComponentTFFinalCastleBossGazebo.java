...
public class ComponentTFFinalCastleBossGazebo extends StructureTFComponentOld {
    ...
    public boolean addComponentParts(World world, Random rand, StructureBoundingBox sbb) {
        ...
        if (deco.blockState.getBlock() == TFBlocks.castle_rune_brick && deco.fenceState.getBlock() == TFBlocks.force_field) {
            try {
                // walls
                ...
                TwilightForestMod.LOGGER.error("Failed to build final castle boss gazebo");
            }
        }
