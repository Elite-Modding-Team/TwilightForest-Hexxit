...
public enum TFFeature {
    ...
    QUEST_ISLAND(1, "quest_island", false) {{
    ...
    DRUID_GROVE(1, "druid_grove", false) {{
        this.disableStructure();
    }},
    FLOATING_RUINS(3, "floating_ruins", false) {{
        this.disableStructure();
    }},
    ...
    FINAL_CASTLE(4, "final_castle", true, TwilightForestMod.prefix("progress_troll")) {
        ...
        protected void addBookInformation(ItemStack book, NBTTagList bookPages) {
            ...
            addTranslatedPages(bookPages, TwilightForestMod.ID + ".book.finalcastle", 2);

            book.setTagInfo("pages", bookPages);
            book.setTagInfo("author", new NBTTagString(BOOK_AUTHOR));
            book.setTagInfo("title", new NBTTagString("The Final Notes"));
        }
