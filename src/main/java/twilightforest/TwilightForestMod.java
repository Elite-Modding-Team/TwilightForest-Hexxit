...
@Mod( modid = TwilightForestMod.ID,
		...
		dependencies = "required-after:mowziesmobs;after:ctm@[MC1.12.2-0.3.2.18,);before:immersiveengineering@[0.12-83,);after:tconstruct;after:conarm;required-after:forge@[14.23.5.2813,);after:thaumcraft@[6.1.BETA21,)",
